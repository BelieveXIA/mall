<template>
    <swiper :options='ScrollOption' ref="swiper">
    ...
    export default{
        ...
        methods: {
            ...
            init() {
                ...
                this.ScrollOption = {
                    direction: 'vertical', // 滚动条垂直方向
                    slidesPerView: 'auto', // 显示几张图片，auto自适应
                    freeMode: true, // 可以自由滚动随意距离
                    setWrapperSize: true, // 获取可滚动页面高度，并设置style.height
                    scrollbar: {
